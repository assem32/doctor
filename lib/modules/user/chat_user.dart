  ...
  Widget build(BuildContext context) {
    return  Builder(
        builder: (BuildContext context){
          UserLayoutCubit.get(context).getMessages(receiverId: umodel!.uId);
                      ...
                      Expanded(
                          child: ListView.separated(
                              ...
                              itemBuilder: (context,index){
                                var message=UserLayoutCubit.get(context).message[index];
                              ...
                              itemCount: UserLayoutCubit.get(context).message.length)
                      ),
                      Container(
